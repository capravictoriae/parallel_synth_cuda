...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright placido, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/synth_tfm_1-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/synth_tfm_1-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/synth_tfm_1-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/synth_tfm_1-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/synth_tfm_1-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/synth_tfm_1-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/synth_tfm_1-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/synth_tfm_1.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/synth_tfm_1.iss",inplace=1):
